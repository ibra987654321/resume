                    ...
                    <div>
                        ...
                        <ul className="mt-12 space-y-8">
                            <li className="flex items-center">
                                ...
                                <a  href="mailto:ibragimmadiyarov@gmail.com" rel="noreferrer" target="_blank" className="text-white text-sm ml-4">
                            ...
                            <li className="flex items-center">
                                ...
                                <a href="https://wa.me/996220168363" rel="noreferrer" target="_blank" className="text-white text-sm ml-4">
                                   +996 220 16 83 63
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul className="flex mt-12 space-x-4">
                            <li className="bg-[#a91079] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                <a href="https://t.me/iorozobaev" rel="noreferrer" target="_blank">
